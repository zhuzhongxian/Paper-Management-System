    ...
    <div id="wrapper">
      ...
      <div id="page-wrapper">
        ...
        <div class="row">
           ...
           <div class="col-lg-12">
            <h1>下载<small>指导学生开题PPT</small> </h1>
            <ol class="breadcrumb">
              <li class="active"></li>
            </ol>
          ...
          <div class="col-lg-12">
            <div class="panel panel-primary">
              <div class="panel-heading">
                <h3 class="panel-title"><i class="fa fa-money"></i> 指导学生开题PPT</h3>
              </div>
                  ...
                  <table class="table table-bordered table-hover table-striped tablesorter">
                    ...
                    <tbody>
                      <tbody>
                        ...
                        <td><div class="button-group"> <a class="button border-main" href="/paper/Public/upload/student/<?php echo ($vo["ppt1"]); ?>">  下载</a>
                         <!--  <a class="button border-main" href="/paper/index.php/Teacher/Index/add/id/<?php echo ($vo["id"]); ?>"> 上传</a> -->
