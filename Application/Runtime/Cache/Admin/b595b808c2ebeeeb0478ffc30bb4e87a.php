...
<div class="panel panel-success" style="padding: 60px 50px 10px;">
    <div class="panel-heading" >
        <h1 class="panel-title" style="padding: 60px 50px 10px;"  font-size: 30px;> <span  style="color: rgb(74, 0, 0); font-size: 30px; padding: 90px 0px 0px -5px">教务管理</span> </h1>
    </div>
 ...
 <div class="container" style="padding: 100px 50px 10px;" >
    ...
    <button type="button" class="btn btn-warning popover-toggle"
            ...
            data-content="上传Excel文件的顺序为，先上传系部数据，再上传用户数据，最后上传导师关系！">
        系统使用说明
