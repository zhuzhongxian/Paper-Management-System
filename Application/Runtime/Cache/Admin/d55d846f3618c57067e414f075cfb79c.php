...
<body>
	<form action="/paper/index.php/Admin/System/into/" enctype="multipart/form-data" method="post" class="form-inline" role="form" style=" padding: 50px 80px 10px 350px" >
...
<p>
  <a href="/paper/index.php/Admin/Index/downloads/name/System" class="btn btn-primary btn-lg btn-block" role="button" >下载系部数据模版</a>
</p>
