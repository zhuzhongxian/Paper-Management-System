...
<body>
	...
	<form action="/paper/index.php/Admin/User/intoUser/" enctype="multipart/form-data" method="post" class="form-inline" role="form" style=" padding: 50px 80px 10px 350px" >
...
<p>
  <a href="/paper/index.php/Admin/Index/downloads/name/Users" class="btn btn-primary btn-lg btn-block" role="button" >下载用户数据模版</a>
</p>
...
<table class="table table-striped">
  ...
  <tbody>
    <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><tr>
      ...
      <td><?php echo ($vol["sid"]); ?></td>
      <td>
        <?php switch($vol["type"]): case "1": ?>管理员<?php break;?>
